...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference("Tarea.count") do
      post tareas_url, params: { tarea: { activo: @tarea.activo, descripcion: @tarea.descripcion } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { activo: @tarea.activo, descripcion: @tarea.descripcion } }
